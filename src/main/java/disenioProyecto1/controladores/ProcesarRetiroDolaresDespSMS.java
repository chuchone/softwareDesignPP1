 ...
 * @author Nelson
 */
@WebServlet("/ProcesarRetiroDolaresDespSMS")
public class ProcesarRetiroDolaresDespSMS extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (resultado) {
                ...
                request.getRequestDispatcher("confirmarRetiroEnDolares.jsp").forward(request, response);
            } else {
