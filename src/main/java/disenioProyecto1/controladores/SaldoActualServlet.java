...
@WebServlet("/SaldoActualServlet")
public class SaldoActualServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (existeCuenta(listaDeCuentas, pinCifrado, numeroCuenta)) {
                ...
                request.getRequestDispatcher("enseniarSaldo.jsp").forward(request, response);
            } else {
