<%-- 
    Document   : confirmarRetiroEnDolares
    Created on : 6 oct. 2024, 12:23:41
    Author     : Nelson
--%>
...
<head>
    <meta charset="UTF-8">
    <title>Confirmación de Retiro en dolares - Sistema Bancario</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <div class="confirmation-box">
            <p>Al cambio de moneda a colones, su retiro de <strong>₡<%= request.getAttribute("montoRetirado") != null ? String.format("%,.2f", (Double) request.getAttribute("montoRetirado")) : "0.00" %></strong> se hizo correctamente</p>
