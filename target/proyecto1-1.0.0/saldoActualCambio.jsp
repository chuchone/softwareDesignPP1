<%-- 
    Document   : saldoActualCambio
    Created on : 2 oct. 2024, 12:22:10
    Author     : Nelson
--%>
...
<body>
    <div class="container">
        <h1>Consultar saldo con tipo de cambio (dolar)</h1>
        <form action="SaldoActualCambioServlet" method="post">
