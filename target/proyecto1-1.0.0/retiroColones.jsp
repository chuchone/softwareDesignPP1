...
<head>
    <meta charset="UTF-8">
    <title>Retiro en Colones - Sistema Bancario</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <form action="ProcesarRetiroColonesServlet" method="post">
